...
namespace ZXing
{
	...
	{
		/// <returns>raw image capture when the barcode was readed </returns>
		...
		public Result(String text,
		                  ...
		                  BarcodeFormat format) : this(text, rawBytes, resultPoints, format, DateTime.Now.Ticks)
		{
		}
		...
		public void putAllMetadata(IDictionary<ResultMetadataType, object> metadata)
		{
			if(metadata != null)
			{
				...
				{
					foreach(var entry in metadata) ResultMetadata[entry.Key] = entry.Value;
				}
			}
		}
